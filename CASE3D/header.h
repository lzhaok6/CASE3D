...
typedef struct owetsurf {
	...
	int FSNEL;   //element number on wet surface 
...
const int hprefg = 1;
const int mappingalgo = 1; //Mapping algoritm, please refer to the description in the main file (1, 2, 3, 4)
...
const int internalmesh = 1;  //==1 means the mesh is generated within the code. Otherwise, an external mesh generated by Gmsh would be imported
