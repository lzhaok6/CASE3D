...
const int dtscale = 1;
const double BETA = 0.5;   //original 
const double TTERM = 0.003;    //SIMULATION END TIME 
const int CAV = 0; //1 for cavitation, 0 for non-cavitation 
...
const int freesurface = 0; 
const int hydrostatic = 0; 
const int tecplot = 0; 